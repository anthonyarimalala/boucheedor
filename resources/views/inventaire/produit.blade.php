    ...
    <div class="col-lg-12 grid-margin stretch-card">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{ asset('liste/Produit') }}" class="text-primary">Voir tous les produits</a>
                <div class="col-lg-4">
                ...
                <div class="table-responsive">
                    <table class="table table-striped" id="dataTable">
                        ...
                        @foreach($v_mouvements as $vm)
                            ...
                            <tr class="type-categorie" onclick="window.location.href='inventaire/detail-produit/{{ $vm->code_produit }}';" style="cursor:pointer;">
                                <td>
                                    {{ $vm->code_produit }}
                                </td>
                                <td>
